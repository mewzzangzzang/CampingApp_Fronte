...
class PetViewHolder(val binding: ItemDonmBinding) : RecyclerView.ViewHolder(binding.root)

class PetListAdapter(val context: PetListActivity, val datas: List<PetList>?) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder =
        PetViewHolder(ItemDonmBinding.inflate(LayoutInflater.from(parent.context), parent, false))
